...
- PER Coding Standard checks employing PHP_CodeSniffer.
- PHPStan analysis at level 9.
- Execution of all tests from the `./tests/*` directory using PHPUnit.

We recommend running `composer run all-check` before committing and creating a pull request.
